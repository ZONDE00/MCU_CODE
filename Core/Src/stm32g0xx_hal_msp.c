...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA4     ------> ADC1_IN4
    */
    GPIO_InitStruct.Pin = ADC_BAT_Pin|ADC_4V_Pin|ADC_3_3V_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA4     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOA, ADC_BAT_Pin|ADC_4V_Pin|ADC_3_3V_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM14_MspPostInit 0 */
    ...
    PB1     ------> TIM14_CH1
    */
    GPIO_InitStruct.Pin = MUX_EN_1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF0_TIM14;
    HAL_GPIO_Init(MUX_EN_1_GPIO_Port, &GPIO_InitStruct);
